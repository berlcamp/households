...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 text-sm leading-6">
      ...
      <p>
        This Privacy Policy describes how the Barangay Information Management
        System ({'"'}the System{'"'}) collects, uses, stores, and protects the
        personal data of barangay residents.
      </p>

      <h2 className="mt-6 text-lg font-semibold">1. Purpose</h2>
      <p>
        The system is used by the Barangay Secretary to maintain accurate and
      ...
      <p>
        Only authorized barangay officials and staff may access resident
      ...
      <p>
        For inquiries or requests, contact the Barangay Secretary at your local
        barangay hall.
      </p>
