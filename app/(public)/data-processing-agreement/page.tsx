  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 text-sm leading-6">
      ...
      <p>
        ...
        Barangay (referred to as {'"'}Data Controller{'"'}) and the System
      ...
      <p>
        The Developer provides a system used by the Barangay for managing
      ...
      <p>
        <strong>Data Controller (Barangay):</strong> Determines the purpose and
      ...
      <p>
        ...
        written authorization from the Barangay.
      </p>

      <h2 className="mt-6 text-lg font-semibold">6. Breach Notification</h2>
      <p>
        The Developer shall notify the Barangay within 24 hours of any data
      ...
      <p>
        ...
        personal data to the Barangay or securely delete it from all systems.
      </p>
      ...
      <p className="mt-4">
        <strong>Barangay:</strong> __________________________ <br />
